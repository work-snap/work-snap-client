...
export default function JobListClient() {
  ...
  const { data: workPlaces, isLoading: wpLoading } = useGetMyWP();
            ...
            >
              ...
              <div className="flex flex-col gap-1 relative">
                ...
                {colorSelectingState[wp.workplace.id] && (
                  <div className="absolute top-7 left-[-4px] px-3 py-3 bg-white rounded-xl border-[0.5px] shadow-lg flex gap-2 z-10">
