    ...
    <div className="h-dvh min-h-0 flex flex-col max-w-[430px] w-full mx-auto bg-white">
      ...
      <div className="flex-1 flex flex-col gap-3 max-h-[1137px] overflow-y-auto ">
        <div className="flex items-center justify-between">
          <span className="ml-4 font-extrabold text-2xl">알바 정보 수정</span>
          {/* 삭제 버튼 */}
          <Button
            type="button"
            onClick={() => setShowDeleteModal(true)}
            className="mr-4 flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-xl h-[40px] text-base"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
