...
export default function SuccessSignup() {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white w-full max-w-[430px] mx-auto h-dvh relative">
      {/* 텍스트 */}
      ...
      {/* 하단 버튼 고정 */}
      <div className="fixed bottom-0 left-0 right-0 p-4 w-full max-w-[430px] mx-auto bg-white">
        <button
          onClick={() => router.push("/user/business/add-business")}
          className="w-full py-5 rounded-lg bg-main text-white font-bold"
        >
          메인으로
        </button>
      </div>
